package com.invillia.acme.store.configuration;
...
public class SwaggerConfiguration extends WebMvcConfigurationSupport {
	...
	private String applicationName = "store";
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.invillia.acme.store")).build().apiInfo(createApiInfo())
