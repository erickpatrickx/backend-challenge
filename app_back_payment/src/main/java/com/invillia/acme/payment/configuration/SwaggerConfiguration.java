package com.invillia.acme.payment.configuration;
...
public class SwaggerConfiguration extends WebMvcConfigurationSupport {
	...
	private String applicationName = "payment";
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.invillia.acme.payment")).build().apiInfo(createApiInfo())
